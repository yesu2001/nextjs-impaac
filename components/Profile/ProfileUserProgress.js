...
export default function ProfileUserProgress({ profile, percent }) {
  ...
  return (
    ...
    >
      {profile?.kyc_status === "submitted" && (
        <Typography
          variant="body2"
          sx={{ textAlign: "center", wordSpacing: 2, fontWeight: "bold" }}
        >
          Documents submitted, expect verification confirmation within 48 hours
          via phone.
        </Typography>
      )}
