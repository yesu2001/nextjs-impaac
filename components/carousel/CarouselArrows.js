...
const leftIcon = (customIcon, isRTL, filled) => (
  <Iconify
    icon={customIcon || filled ? 'eva:arrow-right-fill' : 'ooui:next-ltr'}
    sx={{
      width: 20,
      height: 20,
      transform: ' scaleX(-1)',
...
const rightIcon = (customIcon, isRTL, filled) => (
  <Iconify
    icon={customIcon || filled ? 'eva:arrow-right-fill' : 'ooui:next-ltr'}
    sx={{
      width: 20,
