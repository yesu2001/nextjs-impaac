...
const Mission = () => (
    <Box sx={{ m: { xs: 4, md: 4, sm: 6 } }}>
      <Title
        text="Our Mission: Animal Welfare for All"
        sx={{ color: 'rgb(57,127,183)', textAlign: { xs: 'center', md: 'left' } }}
      />
      <Typography sx={{ mr: { md: 12 }, my: 5 }}>
        At Impaac Foundation, our mission is to empower animal welfare initiatives, touching the lives of strays, pets,
        and wild animals. We provide NGOs a powerful platform to create campaigns for fundraising, nurturing compassion
