...
import camp from './catalogue_Pic/camp.png';
      ...
      <Container maxWidth={'lg'}>
        <Grid container>
          <Grid item xs={12} md={6.5} sx={{ ml: { md: 5 }, my: 5 }}>
            <Title text='Browse Campaigns:' sx={{color:"rgb(57,127,183)" , textAlign:{ xs: 'center' ,sm:'center',md:'left' }}} />
            ...
            >
              <Stack spacing={2} color="#ffffff">
                ...
                Explore our Child Education campaigns and select the one that aligns with your values and interests.
                </Typography>
           </Stack>
            </Card>
          </Grid>
          <Grid item xs={12} md={5} sx={{ display: 'flex', direction: 'row', justifyContent: 'center', p: { xs: 2 }}}>
            <Image component="img" src={camp}  />
          </Grid>
</Grid>
      </Container>
    </Box>
