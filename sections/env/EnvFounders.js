...
import env1 from './catalogue_Pic/8.png';
import env2 from './catalogue_Pic/9.png';
import env3 from './catalogue_Pic/10.png';
...
export default function Founders() {
  const teamMembers = [
    { imgSrc: env1, name: 'Environment Foundation', role: 'Saving Environments for Future' },
    { imgSrc: env2, name: 'Eco Watch', role: 'Help in adopting Sustainability' },
    { imgSrc: env3, name: 'Save Planet Organisation', role: 'Working for Saving Planet' },
  ];
