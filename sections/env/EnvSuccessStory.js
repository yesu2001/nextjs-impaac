...
import story1 from './catalogue_Pic/story1.jpg';
import story2 from './catalogue_Pic/story2.jpg';
import story4 from './catalogue_Pic/story4.jpg';
import story3 from './catalogue_Pic/story3.jpg';
...
export default function EnvSuccessStory() {
  return (
    <Grid container spacing={4} sx={{p:5}}>
      <Grid item xs={12} md={12} sm={12} >
      <Title text='Join the Social' sx={{ color: 'rgb(57,127,183)', textAlign: 'center' }} />
       <Title text='Entrepreneurship Movement' sx={{ color: 'rgb(57,127,183)', textAlign: 'center' }} />
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' ,my:4}}>
          <IconCard >
            <GradeIcon sx={{ color: 'yellow', fontSize: '45px' }} />
            <GradeIcon sx={{ color: 'yellow', fontSize: '45px' }} />
          ...
          <Grid container spacing={1} sx={{ my:10 }}>
            ...
            <Grid item xs={12} md={2.4} sm={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img alt={story3} src={story3} ratio="1/1" width="100%" height="100%" />
            </Grid>
            <Grid item xs={12} md={2.4} sm={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img alt={story2} src={story2} ratio="1/1" width="100%" height="100%" />
            </Grid>
...
//   const renderStoryImages = () => {
//     return storyImages.map((url, index) => (
