...
const Mission = () => (
    <Box sx={{ m: { xs: 4, md: 4, sm: 6 } }}>
      <Title
        text="Our Mission: Environmental Sustainability for All"
        sx={{ color: 'rgb(57,127,183)', textAlign: { xs: 'center', md: 'left' } }}
      />
      <Typography sx={{ mr: { md: 12 }, my: 5 }}>
        At Impaac Foundation, our mission is to empower environmental sustainability, preserving and protecting our
        planet for future generations. We provide NGOs a dynamic platform to create campaigns for raising funds to
