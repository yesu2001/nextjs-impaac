...
import Meera from './catalogue_Pic/meera.png';
import Ckb from './catalogue_Pic/ckb.png';
import Sabar from './catalogue_Pic/sabar.png';
...
export default function Founders() {
  const teamMembers = [
    { imgSrc: Meera, name: 'Meera Charitable Trust', role: 'Helping Poors to Earn' },
    { imgSrc: Ckb, name: 'Chalo Khushiyan Baatien', role: 'Free Food Distribution in Nagpur' },
    { imgSrc: Sabar, name: 'Sabar NGO', role: 'Working towards treating poors' },
  ];
