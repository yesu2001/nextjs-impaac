...
const Mission = () => (
    <Box sx={{ my: { xs: 4, md: 4, sm: 6 } }}>
      <Title
        text="Our Mission: Empowering Education for All"
        sx={{ color: 'rgb(57,127,183)', textAlign: { xs: 'center', md: 'left' } }}
      />
      <Typography sx={{ mr: { md: 12 }, my: 5 }}>
        At Impaac Foundation, our mission is to empower education, lighting the path to knowledge and enabling access to
