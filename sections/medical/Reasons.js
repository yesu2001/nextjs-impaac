import { Typography, Container, Box, Grid, Fade } from '@mui/material';
import { m, AnimatePresence } from 'framer-motion';
import useSettings from '../../hooks/useSettings';
import Image from '../../components/Image';
import handsImage from './catalogue_Pic/19.webp';
            ...
            >
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Box sx={{ position: 'absolute', top: { xs: -80, sm: -100, md: -150 } }}>
                    <Image
                      src={item.image}
                      alt={item.image}
                ...
                >
                  <Typography variant="h5" sx={{ textAlign: { xs: 'center', md: 'center' } }}>
                    {item.title}
                  </Typography>
                  <Typography variant="subtitle2" sx={{ fontSize: { xs: '15px' }, textAlign: 'inherit' }}>
                    {item.content}
                  </Typography>
                </Box>
              </m.div>
