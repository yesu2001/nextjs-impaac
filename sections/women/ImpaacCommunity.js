    ...
    <Grid container sx={{ py: 10,px:{md:5}}} spacing={3}>
      ...
      <Grid item xs={12} sm={12} md={6} lg={6} spacing={3} >
        ...
        <Box sx={{ display: 'flex', justifyContent: { xs: 'center', md: 'flex-start' }, alignItems: { xs: 'center', md: 'flex-start' }, mt: 2 }}>
          <CustomButton>
            Contact Us <img width="30" height="30" src="https://img.icons8.com/ffffff/external-tanah-basah-basic-outline-tanah-basah/24/external-right-arrow-arrows-tanah-basah-basic-outline-tanah-basah.png" alt="external-right-arrow-arrows-tanah-basah-basic-outline-tanah-basah" />
          </CustomButton>
        </Box>
