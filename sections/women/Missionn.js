...
const Mission = () => (
    <Box sx={{ m: { xs: 4, md: 4, sm: 6 }}}>
      <Title text='Our Mission: Womens Empowerment for All' sx={{color:"rgb(57,127,183)" ,textAlign:{xs:'center', md:'left'}}} />
      <Typography sx={{ mr: { md: 12 }, my: 5, fontSize: { sm: 25, md: 20, xs: 19 } }}>
      At Impaac Foundation, our mission is to empower women, unlocking their potential and fostering equality. We provide NGOs a dynamic platform to create campaigns for raising funds to advance women's causes across India and around the world.
