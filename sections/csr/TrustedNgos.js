...
const TrustedNgosContent = () => (
    <Box  sx={{ m: { xs: 4, md: 4, sm: 6 }}}>
      ...
      Individuals, you'll find thousands of dedicated NGOs on our platform, each with a unique mission for educational empowerment. Join us in making the world a better place for learners.

      
      <ul style={{ paddingTop: 20, marginLeft: 20 }}>
          <li><b>Empower with Ease:</b> Discover a vast network of trusted NGOs, each with a unique mission for educational empowerment.</li>
