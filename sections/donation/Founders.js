...
import letthepawroar from './catalogue_Pic/letthepawroar.png';
import earthlings from './catalogue_Pic/earthlings.png';
import stronglittle from './catalogue_Pic/stronglittle.png';
...
export default function Founders() {
  const teamMembers = [
    { imgSrc: letthepawroar, name: 'Let the Paw Roar', role: 'Saving Little Animals' },
    { imgSrc: earthlings, name: 'Earthlings Trust', role: 'Rescuing animals and vaccination' },
    { imgSrc: stronglittle, name: 'Strong Little Paws', role: 'Helping animals to survive' },
  ];
