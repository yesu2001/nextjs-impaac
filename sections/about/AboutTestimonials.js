            ...
            <Box sx={{ maxWidth: { md: 360 } }}>
              ...
              <m.div variants={varFade().inUp}>
                <Typography sx={{ color: "text.secondary" }}>
                  Our goal is to create a platform that you’re satisfied with.
                  This is why we’re constantly working on our services to make
                  it better every day and really listen to what our users has to
                  say.
                </Typography>
              </m.div>
            </Box>
