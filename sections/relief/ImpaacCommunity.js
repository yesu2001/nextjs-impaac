...
import community from './cataloguePics/16.png';
import msg from '../animal/catalogue_Pic/msg.png';
import call from '../animal/catalogue_Pic/call.png';
import website from '../animal/catalogue_Pic/website.png';
import address from '../animal/catalogue_Pic/address.png';
        ...
        <Grid item xs={12} sm={12} md={6} lg={6} spacing={3}>
          ...
          <Stack spacing={3} mt={4} sx={{ mx: { sm: 5, md: 0, xs: 5 } }}>
            ...
            <ReasonBox>
              ...
              <ContentStyle>Bengaluru, India</ContentStyle>
            </ReasonBox>
          </Stack>
        </Grid>
      </Grid>
