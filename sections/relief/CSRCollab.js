...
import csr from './cataloguePics/15.png';
    ...
    <Box sx={{ m: { xs: 4, md: 4, sm: 6 } }}>
      ...
      <Typography sx={{ mr: { md: 12 }, my: 5 }}>
        ...
        <ul style={{ paddingTop: 20, marginLeft: 20 }}>
          <li>
            <b>CSR Partnerships:</b>Benefit from our collaborations with numerous CSR companies committed to animal
            welfare.
          </li>
          <li>
    ...
    <Grid container sx={{ m: 0 }}>
      <Stack spacing={1} alignItems="center" direction={{ xs: 'column', md: 'row' }}>
        ...
        <Grid item xs={12} md={6} lg={6} sx={{ display: 'flex', justifyContent: 'center', mt: { xs: 4 } }}>
          <Image alt={csr} src={csr} sx={{ width: { md: '85%' } }} />
        </Grid>
      </Stack>
    </Grid>
  );
